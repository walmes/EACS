---
title: "Experimento fatorial fuplo com um controle negativo"
author: >
...
output:
  html_document:
    code_folding: show
vignette: >
  %\VignetteIndexEntry{Experimento fatorial fuplo com um controle negativo}
...
A tabela de frequencia mostra o que já sabemos: temos um experimento
...
O gráfico de cima mostra que existe uam leve diferença do desempenho da
...
foi um acidente mas algo planejedado fazer o experimento da forma como
feito.
...
aplicação. Restou, portanto, apenas o efeito de fonte de abubo.
...
# Dosdobramento das somas de quadrados
...
o que é exclusido de `fonte` e `modo`. Em ambos os casos, não muda o
resultado para a intervação, que foi não significativa.

# Obtenção das médias ajustadas

As médias ajustadas são médias obtidias por meio de funções lineares dos
