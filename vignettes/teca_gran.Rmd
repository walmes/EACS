...
## Regressão multipla com seleção de variáveis por stepwise
...
vimp <- cbind("bsr" = unname(varImp(fit_bsr)$importance),
              "las" = unname(varImp(fit_las)$importance),
              "rfr" = unname(varImp(fit_rfr)$importance),
              "pcr" = unname(varImp(fit_pcr)$importance))
vimp
